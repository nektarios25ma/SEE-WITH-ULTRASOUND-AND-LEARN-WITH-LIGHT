...
Α) ΒΛΕΠΩ ΜΕ ΤΟΝ ΥΠΕΡΗΧΟ ΚΑΙ ΜΑΘΑΙΝΩ ΜΕ ΤΟ ΦΩΣ
 Με την βοήθεια MCU π.χ. esp32 και κατάλληλων αισθητήρων θα δημιουργήσουμε ένα εργαστηριακό εργαλείο που αναδεικνύει την συμπεριφορά των ηχητικών-υπερηχητικων κυμάτων στον αέρα  δείχνοντας τους παράγοντες από τους οποίους εξαρτάται . Παράλληλα θα μελετήσουμε τον τρόπο με τον οποίο τα δελφίνια και τα υποβρύχια βλέπουν με τον υπέρηχο και αντιλαμβάνονται το υποθαλάσσιο περιβάλλον. Όμοια θα ανιχνεύσουμε την συμπεριφορά του φωτός (ορατού ή υπέρυθρου) ως κύμα και την εξάρτηση του από περιβαλλοντικούς παράγοντες (TOF).
